...
- **Инструменты для файлов проекта**: просмотр и загрузка файлов, предпросмотр исходного кода, Markdown, изображений, аудио, PDF и DOCX с автоматическим обновлением.
